export default function CrearClonDeRafaelParaHealthPage() {
  return (
    <div style={{ background: "#050505", color: "#00ff88", minHeight: "100vh", padding: "40px", fontFamily: "monospace" }}>
      <h1>ORA — Crear Clon De Rafael Para Health</h1>
      <p>Módulo crear-clon-de-rafael-para-health generado por ORA desde intención estructural.</p>
