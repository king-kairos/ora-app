export default function CrearClonRafaelHealthPage() {
  return (
    <div style={{ background: "#050505", color: "#00ff88", minHeight: "100vh", padding: "40px", fontFamily: "monospace" }}>
      <h1>ORA — Crear Clon Rafael Health</h1>
      <p>Módulo crear-clon-rafael-health generado por ORA desde intención estructural.</p>
