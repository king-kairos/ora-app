export default function CrearRamaPruebaKairosPage() {
  return (
    <div style={{ background: "#050505", color: "#00ff88", minHeight: "100vh", padding: "40px", fontFamily: "monospace" }}>
      <h1>ORA — Crear Rama Prueba Kairos</h1>
      <p>Módulo crear-rama-prueba-kairos generado por ORA desde intención estructural.</p>
